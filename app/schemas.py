...
class UserCreate(BaseModel):
    ...
    role: str = Field(default="buyer", pattern="^(admin|buyer|seller)$", description="Роль: 'buyer' или 'seller'")
