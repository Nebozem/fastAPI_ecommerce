...
from app.auth import admin_checkout
...
async def create_category(category: CategoryCreate, db: AsyncSession = Depends(get_async_db), current_user: UserModel = Depends(admin_checkout)):
    """
...
async def update_category(category_id: int, category: CategoryCreate, db: AsyncSession = Depends(get_async_db), current_user: UserModel = Depends(admin_checkout)):
    """
...
async def delete_category(category_id: int, db: AsyncSession = Depends(get_async_db), current_user: UserModel = Depends(admin_checkout)):
    """
